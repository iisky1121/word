    ...
    private static void watchHttp(String resource, final ResourceLoader resourceLoader) {
        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                String password = WordConfTools.get("redis.password", null);
                int database = WordConfTools.getInt("redis.database", 0);
                ...
                while (true) {
                    try {
                        JedisPool jedisPool = new JedisPool(new JedisPoolConfig(), host, port, Protocol.DEFAULT_TIMEOUT, password, database);
