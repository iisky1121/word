            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (line.startsWith("sa=")) {
                    switch (line.substring(3)) {
                        case "cos":
                            setTextSimilarity(new CosineTextSimilarity());
                            continue;
                        case "edi":
                            setTextSimilarity(new EditDistanceTextSimilarity());
                            continue;
                        case "euc":
                            setTextSimilarity(new EuclideanDistanceTextSimilarity());
                            continue;
                        case "sim":
                            setTextSimilarity(new SimpleTextSimilarity());
                            continue;
                        case "jac":
                            setTextSimilarity(new JaccardTextSimilarity());
                            continue;
                        case "man":
                            setTextSimilarity(new ManhattanDistanceTextSimilarity());
                            continue;
                        case "shh":
                            setTextSimilarity(new SimHashPlusHammingDistanceTextSimilarity());
                            continue;
                        case "ja":
                            setTextSimilarity(new JaroDistanceTextSimilarity());
                            continue;
                        case "jaw":
                            setTextSimilarity(new JaroWinklerDistanceTextSimilarity());
                            continue;
                        case "sd":
                            setTextSimilarity(new SørensenDiceCoefficientTextSimilarity());
                            continue;
                    }
                    continue;
                }
